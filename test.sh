...
run_test 3 70 1200 "0.1591"   # Priemerne veľké auto
run_test 5 100 2000 "0.2381"  # Silnejšia osoba, veľké auto
run_test 1 60 800 "0.0750"    # Krátka tyč, malé auto
run_test 6 150 3000 "0.3000"  # Veľmi dlhá tyč, extrémne veľké auto
run_test 2 70 70 "1.0000"     # Rovnaká váha človeka a auta

echo "Všetky testy prešli úspešne!"
